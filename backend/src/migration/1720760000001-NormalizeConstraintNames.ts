...
export class NormalizeConstraintNames1720760000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_category_name_user\` ON \`category\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_image_category_category\` ON \`image_categories_category\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_image_category_image\` ON \`image_categories_category\``,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_4760fde1380c4d39297a2e1f98\` ON \`category\` (\`name\`, \`userId\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_96306bf482c0acf805cd0fd688\` ON \`image_categories_category\` (\`imageId\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_f67ec53757f47fb0c38f396c37\` ON \`image_categories_category\` (\`categoryId\`)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`image_categories_category\` ADD CONSTRAINT \`FK_96306bf482c0acf805cd0fd6888\` FOREIGN KEY (\`imageId\`) REFERENCES \`image\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE \`image_categories_category\` ADD CONSTRAINT \`FK_f67ec53757f47fb0c38f396c37f\` FOREIGN KEY (\`categoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_f67ec53757f47fb0c38f396c37\` ON \`image_categories_category\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_96306bf482c0acf805cd0fd688\` ON \`image_categories_category\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_4760fde1380c4d39297a2e1f98\` ON \`category\``,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_image_user\` ON \`image\` (\`userId\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_category_name_user\` ON \`category\` (\`name\`, \`userId\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_image_category_image\` ON \`image_categories_category\` (\`imageId\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_image_category_category\` ON \`image_categories_category\` (\`categoryId\`)`,
    );
    await queryRunner.query(
